...
/** 
 * @type {import('@fizzxydev/baileys-pro')}
 */
const {
...
export function makeWASocket(connectionOptions, options = {}) {
    /**
     * @type {import('@fizzxydev/baileys-pro').WASocket | import('@fizzxydev/baileys-pro').WALegacySocket}
     */
	...
	sendContact: {
             ...
             * @param {import('@fizzxydev/baileys-pro').proto.WebMessageInfo} quoted 
	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363411390148237@newsletter',
            newsletterName: '『𝑮𝒊𝒂𝒏𝒕𝒔 - 𝑩𝒐𝒕』', 
            serverMessageId: '' }, 
                ...options
                }
                })
      ...
      ...options
        ...
        sendFile: {
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                /**
                 * @type {import('@fizzxydev/baileys-pro').proto.WebMessageInfo}
                 */
                let m
                try {
...
let canalId = ["120363411390148237@newsletter", "120363411390148237@newsletter", "120363411390148237@newsletter", "120363411390148237@newsletter"]
let canalNombre = ["『𝑮𝒊𝒂𝒏𝒕𝒔 - 𝑩𝒐𝒕』", "『𝑮𝒊𝒂𝒏𝒕𝒔 - 𝑩𝒐𝒕』", "『𝑮𝒊𝒂𝒏𝒕𝒔 - 𝑩𝒐𝒕』", "『𝑮𝒊𝒂𝒏𝒕𝒔 - 𝑩𝒐𝒕』"]
...
return conn.sendMessage(jid, { poll: { name, values, selectableCount }})
    ...
    conn.sendMessage(jid, { video: gif, gifPlayback: true, gifAttribution: b, caption: text, footer: footer, jpegThumbnail: file, templateButtons: but, ...options })
        ...
        loadMessage: {
             ...
             * @returns {import('@fizzxydev/baileys-pro').proto.WebMessageInfo}
             */
            value(messageID) {
        ...
        processMessageStubType: {
             ...
             * @param {import('@fizzxydev/baileys-pro').proto.WebMessageInfo} m 
             */
            async value(m) {
                ...
                for (const message of m) {
                    try {
                        ...
                        if (message.message?.[mtype]?.contextInfo?.quotedMessage) {
                            /**
                             * @type {import('@fizzxydev/baileys-pro').proto.IContextInfo}
                             */
                            let context = message.message[mtype].contextInfo
                            let participant = conn.decodeJid(context.participant)
                            const remoteJid = conn.decodeJid(context.remoteJid || participant)
                            /**
                             * @type {import('@fizzxydev/baileys-pro').proto.IMessage}
                             * 
                             */

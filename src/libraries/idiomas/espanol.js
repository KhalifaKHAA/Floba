const lenguaje = () => { return 'es' } //عرب

//إشعارات الرسائل
const smsAvisoRG = () => { return `⋄┄┄〘 تنبيه🔥 〙┄┄⋄\n\n` }
const smsAvisoAG = () => { return `〘 تنبيه❗ 〙` }
const smsAvisoIIG = () => { return `*❐⊹•╾╾─•─❯┇🔐┇❮─•─╼╼•⊹❐*` }
const smsAvisoFG = () => { return `⋄┄┄〘 تنبيه❗ 〙┄┄⋄\n\n` }
const smsAvisoMG = () => { return `⋄┄┄〘 خطاء❌ 〙┄┄⋄\n\n` }
const smsAvisoEEG = () => { return `⋄┄┄〘 بلغ يحب🧞‍♂️ 〙┄┄⋄\n\n` }
const smsAvisoEG = () => { return `⋄┄┄〘 تم بنجاح🧚‍♀️🔥 〙┄┄⋄\n\n` }
...
const smsSpromote = () => { return '*[⚡]⌯  لقد اصبحت الآن مشرفا\n\nالي رفعك ادمن ${usuario}'}
const smsSdemote = () => { return '*[⚡]⌯  لم تعد مشرفا بعد الان\n\nالي نزاك من ادمن ${usuario}*'}
const smsSdesc = () => { return '*[⚡]⌯ تــم تـحـديـث وصــف الــجــروب\n\n⌯ الــوصــف الــجــديــد : @desc*'}
const smsSsubject = () => { return '*[⚡]⌯ تـــم تــغــيــر اســم الــجــروب\n⌯ الــاســم الــجــديــد : @subject*'}
const smsSicon = () => { return '[⚡]⌯ تـــم تــغــيــر صــوره الــمــجــمــوعـــه'}
const smsSrevoke = () => { return '*[⚡]⌯ تــم تـغـيـر رابــط الـمـجـمــوعــه\n⌯ الــرابــط الـجـديـد : @revoke*'}
...
//نص
const smsConMenu = () => { return `『الاوامر🥷🔥』`}
...
//_antiviewonce.js
const smsAntiView = () => { return `『مفيش حاجه بتخفي هنا يصحبي😁』`} 

//_autolevelup.js
const smsAutoLv1 = () => { return `『مستوى جديد🥷🔥』`} 
const smsAutoLv2 = () => { return `『المستوى السابق🥷🔥』:`} 
const smsAutoLv3 = () => { return `『المستوى الحالي🥷🔥』:`} 
const smsAutoLv4 = () => { return `『رتبتك🥷🔥』:`} 
const smsAutoLv5 = () => { return `『التاريخ🥷🔥』:`} 
const smsAutoLv6 = () => { return `『مبروك وصلت لمستوى جديد🥷🔥』`} 
const smsAutoLv7 = () => { return `『مكافتك للمستوي الجديد🥷🔥』`} 

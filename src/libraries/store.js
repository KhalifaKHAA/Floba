 ...
 * specifically the @fizzxydev/baileys-pro version, to handle events, manage chats, 
 ...
 */
const { BufferJSON, proto, isJidBroadcast, WAMessageStubType, updateMessageWithReceipt, updateMessageWithReaction, jidNormalizedUser } = (await import('@fizzxydev/baileys-pro')).default;
...
const {initAuthCreds, BufferJSON, proto, jidNormalizedUser} = (await import('@fizzxydev/baileys-pro')).default;
function bind(conn) {
  if (!conn.chats) conn.chats = {};

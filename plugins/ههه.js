...
// Convert milliseconds to clock string format
                                        ...
                                        sections: [
                                            {
                                                ...
                                                rows: [
                                                    ...
                                                    { header: '🛡┊القـ🛡ـسـم الرابع', title: '🍬┊「قـسـم_التـحـمـيـل」🍨', id: '.ق5' },
                                                    { header: '🕹┊القـ🕹ـسـم الخامس', title: '🍬┊「قـسـم_البـنـك」🍨', id: '.ق6' },
                                                    { header: '🌀┊القـ🌀ـسـم السادس', title: '🍬┊「قـسـم_الــAI」🍨', id: '.ق7' },
                                                    { header: '🤖┊القـ🤖ـسـم السابع', title: '🍬┊「قـسـم_التـسـلـيـه」🍨', id: '.ق9' },

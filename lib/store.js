 ...
 */
const { initAuthCreds, BufferJSON, proto } = (await import('@fizzxydev/baileys-pro')).default

/**
 * @param {import('@fizzxydev/baileys-pro').WASocket | import('@fizzxydev/baileys-pro').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('@fizzxydev/baileys-pro').Contact[]|{contacts:import('@fizzxydev/baileys-pro').Contact[]}} contacts 
     * @returns 
     */

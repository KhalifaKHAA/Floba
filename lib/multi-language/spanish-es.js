...
┇≡ ◡̈⃝🥷⚡️ *لقد غير ${usuario} اسم المجموعه بنجاح*
❐⊹━━━━━『𝑻𝑼𝑹𝑩𝑶』━━━━━⊹❐
┇≡ ◡̈⃝🥷⚡️ *الاسم الجديد:* ${m.messageStubParameters[0]}
┗━━━━━━━━━━━━━━━━⬣*`, 
smsAutodetec2: (usuario, groupMetadata) => `*┏━━━━━━━━━━━━━━━━⬣
┇≡ ◡̈⃝🥷⚡️ لقد غير ${usuario} بروفايل المجموعه بنجاح
❐⊹━━━━━『𝑻𝑼𝑹𝑩𝑶』━━━━━⊹❐
┇≡ ◡̈⃝🥷⚡️ التي اسمها ${groupMetadata.subject}
┗━━━━━━━━━━━━━━━━⬣*`, 
smsAutodetec3: (usuario, m) => `*┏━━━━━━━━━━━━━━━━⬣
┇≡ ◡̈⃝🥷⚡️  لقد غير ${usuario} وصف المجموعه بنجاح
❐⊹━━━━━『𝑻𝑼𝑹𝑩𝑶』━━━━━⊹❐
┇≡ ◡̈⃝🥷⚡️ الوصف الجديد الان: ${desc}
┗━━━━━━━━━━━━━━━━⬣`, 
...
smsAutodetec6: (m) => `
*❐🔐┇${m.messageStubParameters[0] === 'on' ? 'تم قفل الجروب' : 'تم فتح الجروب'}┇🔐❐*
*❐⊹•╾╾─•─❯┇🔐┇❮─•─╼╼•⊹❐*
*❐┇${m.messageStubParameters[0] === 'on' ? 'الادمنز والمشرفين فقط يمكنهم التحدث' : 'الجميع يستطيع التحدث الآن'}┇❯*`, 
smsAutodetec7: (m, usuario) =>  `*┏┅ ━━━━━━━━━━━━━━━━ ┅ ━┓*
*┃🐉↵ ٭〘 @${m.messageStubParameters[0].split`@`[0]} 〙٭*
*┃🥷↵ ٭تـمـت تـرقـيـتـه إلـى مـشـرف↻٭*
*┣┅ ━━━━━『𝑻𝑬𝑹𝑩𝑶』━━━━ ┅ ⊹❐
*┃📍↵ ٭بـــواســـطـــة٭ ↯ [ 🔥 ]*
*┃↵ ٭〘 ${usuario}⁩ 〙٭*
*┗┅ ━━━━━━━━━━━━━━━━ ┅ ━┛*

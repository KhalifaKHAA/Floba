...
/** @type {typeof import('@fizzxydev/baileys-pro')} */ // @ts-ignore
const {
    initAuthCreds,
    BufferJSON,
    proto,
...
} = (await import('@fizzxydev/baileys-pro')).default
...
function makeInMemoryStore() {
    /** @type {{ [jid: string]: { id: string, lastfetch?: number, subject?: string, name?: string, isChats?: boolean, isContact?: boolean, presence?: import('@fizzxydev/baileys-pro').PresenceData, metadata?: import('@fizzxydev/baileys-pro').GroupMetadata } & import('@fizzxydev/baileys-pro').Chat & import('@fizzxydev/baileys-pro').Contact }}} */
    let chats = {}
    /** @type {{ [jid: string]: import('@fizzxydev/baileys-pro').proto.WebMessageInfo[] }} */
    let messages = {}
    /** @type {import('@fizzxydev/baileys-pro').ConnectionState} */
    ...
    function loadMessage(jid, id = null) {
        ...
        if (jid && !id) {
            id = jid
            /** @type {(m: import('@fizzxydev/baileys-pro').proto.WebMessageInfo) => Boolean} */
    ...
    /**
     * @param {string} jid 
     * @param {(jid: string) => Promise<import('@fizzxydev/baileys-pro').GroupMetadata> | null} groupMetadata 
     */
    ...
    /**
     * @param {string} jid 
     * @param {import('@fizzxydev/baileys-pro').proto.WebMessageInfo} message 
     */
    ...
    /** 
     * @param {import('@fizzxydev/baileys-pro').BaileysEventEmitter} ev 
     * @param {{ groupMetadata: (jid: string, minimal?: boolean) => Promise<import('@fizzxydev/baileys-pro').GroupMetadata> | null }} opts
     */
...
/**
 * 
 * @returns {ReturnType<typeof import('@fizzxydev/baileys-pro').useSingleFileAuthState>}
 */
